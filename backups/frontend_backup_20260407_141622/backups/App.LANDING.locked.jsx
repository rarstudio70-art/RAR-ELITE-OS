      ...
      <div className="mx-auto flex min-h-screen max-w-[1400px] flex-col px-6 py-6">
        ...
        <section className="w-full">
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            ...
            {/* RIGHT SIDE PLACEHOLDER (kept simple so hero stays balanced) */}
            <div className="hidden md:block" />
          </div>

          {/* REACTOR-GLASS SYSTEM STRIP (FULL WIDTH, CENTERED, FLOATING) */}
        ...
        <section className="mt-10 max-w-5xl mx-auto w-full">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { name: "Atlas", role: "Research and Knowledge" },
              { name: "Nova", role: "Vision and Design" },
              { name: "Echo", role: "Communication" },
              { name: "Spectra", role: "Data and Insight" },
        ...
        <section className="mt-12 max-w-5xl mx-auto w-full grid gap-8 md:grid-cols-[1.2fr,1fr] md:items-center">
          ...
          >
            ...
            {/* Admin console appears here when unlocked */}
            {adminUnlocked && (
              <div className="mt-5">
                <AdminConsole />
              </div>
